...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a Sutton-only papers CSV from cached arXiv API XML files."
    )
    parser.add_argument(
        "--author-dir",
    ...
    parser.add_argument(
        "--output",
        default="papers-sutton-richard.csv",
        help="Output CSV path (default: papers-sutton-richard.csv).",
    )
